# Ex.No: 11  Mini Project - AI enable shooting game 
### DATE: 25/10/2024                                                                           
### REGISTER NUMBER : 212221220060
### AIM: 
To develop a 2D shooting game using Python and Pygame, where a player character battles AI-controlled enemies with animations, health management, scoring, and respawn mechanics. The game will feature smooth character movement, attack animations, and an engaging gameplay experience with a final score display on game over.
